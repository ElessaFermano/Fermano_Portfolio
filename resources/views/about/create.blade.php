...
<div class="card">
  ...
  <br>
      <form action="{{ url('about') }}" method="post">
        ...
        <label>Brgy</label></br>
        <input type="text" name="brgy" id="brgy" class="form-control" required></br>
        <label>Municipality</label></br>
        <input type="text" name="municipality" id="municipality" class="form-control" required></br>
        <label>Province</label></br>
        <input type="text" name="province" id="province" class="form-control" required></br>
        <label>Zipcode</label></br>
        <input type="double" name="zipcode" id="zipcode" class="form-control" required></br>
